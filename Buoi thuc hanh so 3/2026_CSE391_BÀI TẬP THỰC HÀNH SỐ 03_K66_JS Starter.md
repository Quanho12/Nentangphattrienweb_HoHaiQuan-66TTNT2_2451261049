...
- Thấy dòng " Hello form Javascript !"
- Điều này cho e biết ngay sau khi tải xong tệp main.js, engine JavaScript của trình duyệt đã lập tức đọc và chạy các dòng lệnh có bên trong tệp đó một cách tự động trong quá trình render trang web.
---
...
>
> - HTML: ................cấu trúc và nội dung__........................................
> - CSS: ...................Giao diện và trình bày__.....................................
> - JavaScript: .............Hành vi và tương tác__.....................................
...
>   - `string` là: ......chuỗi ký tự
 ........................................
>   - `boolean` là: ......Kiểu dữ liệu đúng sai 
.......................................
...
Em thấy được những thông báo mà e code trong phần main.js
> - Em gặp lỗi cú pháp nào? Em đã xử lý bằng cách nào (tự sửa, hỏi bạn, đọc lỗi, tìm Google, …)?
khi e gặp lỗi thiếu dấu +, e sẽ hỏi AI sai ở đâu và tìm cách sửa cho đúng
---
...
- Chuong trình in "giỏi" khi khai báo score lớn hơn hoặc bằng 8;
- Chương trình in "yếu" khi khai báo score nhỏ hơn 5
........................................................................
........................................................................
...
>   - Thân hàm (body): ............toàn bộ if else, phần tính m1+m2+m3 /3
.............................
>   - Giá trị trả về (return): ...........return avg, chuỗi văn bản 
......................
> - Ưu điểm của việc dùng hàm thay vì lặp lại cùng một đoạn code nhiều lần là gì?
Nhanh, dễ hiểu, dễ sử dụng
---
...
Cấu trúc bên trong mỗi hàm, làm sao để hiểu đc hàm đó cần có gì 
> - Em đã làm gì để vượt qua (thử nhiều lần, hỏi bạn, xem lại ví dụ, tra Google, …)?
Thử nhiều lần, xem lại ví dụ, tra gg
...
- tìm phần tử có thuộc tính id = status, sau đó lưu phần tử vào biến statusEL
> - Sự kiện `"click"` xảy ra khi nào?
Xảy ra khi bấm vào btnHello
> - Trong đoạn code trên, khi nhấn nút `btnHello`, điều gì thay đổi trên trang?
Sau khi bấm, web sẽ hiện lên dòng chữ "Xin chào! Đây là nội dung được thay đổi bằng JavaScript.";
---
...
Input là nhập vào, còn click là bấm 
> - Khi em xoá hết nội dung ô input, dòng `greeting` hiển thị gì?
Dòng greeting sẽ hiện XIn chào, !
---
...
>   ....là bản đồ sơ đồ cây từ trên xuống đưới của trang web
............................................................
...
đều là tìm biến có id là btnHello
> - Điểm khác nhau về cú pháp là gì (`document.getElementById` vs `$("#id")`, `addEventListener` vs `.on`)?
JavaScript thuần (Vanilla JS) sử dụng hàm document.getElementById("btnHello") khá dài dòng và mang tính mô tả cao.

jQuery sử dụng ký hiệu $ (đại diện cho thư viện jQuery) kết hợp với cú pháp bộ chọn là $("#btnHello"), giúp code ngắn gọn.
> - Em hãy tra cứu nhanh “What is jQuery used for?” và ghi 2 ý chính:
>   1. ...Đơn giản hóa thao tác DOM và tạo hiệu ứng.............................................................
>   2. ....Xử lý AJAX và tương thích trình duyệt (Cross-browser)............................................................
